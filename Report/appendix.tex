...
\lstinputlisting[caption = \texttt{imem.mif}, label = lst:imemmif, keywords = {}]{../imem.mif}
...
\lstinputlisting[caption = \texttt{ramlpm.mif}, label = lst:rammif, keywords = {}]{../ramlpm.mif}
