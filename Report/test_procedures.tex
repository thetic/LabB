...
%TODO test datapath
\begin{enumerate}
    \item The datapath circuit will be tested using \emph{ModelSim} and the testbench shown in %TODO Figure 9, Appendix A.
    This testbench generates the test vectors shown in \hyperref[tab:datapath_vectors]{Table \ref*{tab:datapath_vectors}} and output %TODO $O$.
...
%TODO test processor
\begin{enumerate}
    \item The processor circuit will be tested using \emph{ModelSim} and the testbench shown in %TODO Figure 9, Appendix A.
